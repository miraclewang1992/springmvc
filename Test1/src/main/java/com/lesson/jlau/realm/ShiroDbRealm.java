...
public class ShiroDbRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(
		...
		Student stu = studentService.findStuByLoginName(token.getUsername());
		System.out.println(stu);
		if (stu != null) {
			return new SimpleAuthenticationInfo(stu.getStuName(), stu.getStuPassword(), getName());
		}else{
